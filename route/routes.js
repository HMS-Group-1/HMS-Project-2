...
router.patch('/admin/updateUser/:id', verifyUserToken, verifyAdmin, updateUsers);
...
router.post('/admin/createBook', verifyUserToken, verifyAdmin, createBooks);
router.patch('/admin/updateBook/:id', verifyUserToken, verifyAdmin, updateBooks);
